            ...
            const data: Array<{ title: string; icon: string; items: Array<Skill> }> = [
              ...
              },
              {
                ...
                items: [
                  ...
                  { category: "Dev", name: "SwiftUI", percent: 60, level: "Advanced", notes: "MVVM, Core Data basics" },
                  ...
                  { category: "Dev", name: "Java", percent: 50, level: "Advanced" },
                  { category: "Dev", name: "C/C++", percent: 35, level: "Advanced" },
                  { category: "Dev", name: "Node.js", percent: 40, level: "Intermediate" },
