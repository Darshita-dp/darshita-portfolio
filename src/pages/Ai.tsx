...
function InterviewMe() {
  ...
  return (
    <div className="h-full bg-[#D4E8E4] dark:bg-slate-900 relative overflow-hidden flex items-center justify-center">
      ...
      <div 
        className="container mx-auto max-w-3xl px-4 py-2 relative z-10 h-full flex items-center"
        style={{
          height: "calc(100dvh - 56px - 56px - 16px)", // 100vh - topbar - footer - minimal padding
          minHeight: "400px"
        }}
      >
