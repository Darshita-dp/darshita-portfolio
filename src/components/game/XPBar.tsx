  ...
  return (
    <div
      ...
      style={{
        ...
        background: `linear-gradient(180deg, ${BYTE_BUBBLES_THEME.bgStart}20 0%, ${BYTE_BUBBLES_THEME.bgMid}15 50%, ${BYTE_BUBBLES_THEME.bgEnd}20 100%)`,
        borderRight: `1px solid ${BYTE_BUBBLES_THEME.accent}10`,
    ...
    >
      ...
      {/* XP Label */}
      <div
        className="text-sm md:text-base font-semibold tracking-wider mt-2"
        style={{
          color: "#000000",
