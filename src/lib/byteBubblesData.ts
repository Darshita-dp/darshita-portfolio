...
export const BUBBLE_NODES: BubbleNode[] = [
  ...
  { id: 2, label: "Education", x: 22, y: 48, type: "memory" },
  { id: 3, label: "Experience", x: 34, y: 58, type: "quiz" },
  { id: 4, label: "Projects", x: 46, y: 46, type: "puzzle" },
  { id: 5, label: "Impact", x: 58, y: 56, type: "timeline" },
  { id: 6, label: "Design", x: 70, y: 44, type: "design" },
  { id: 7, label: "Future", x: 82, y: 52, type: "boss" },
  { id: 8, label: "Under Construction", x: 94, y: 40, type: "sign" },
];
